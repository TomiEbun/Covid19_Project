...
-----Percentage_of_Population_Vaccinated
...
----3
--Location_with_the_highest_Death_Count
...
-----4
--Country with the highest infection count AS
...
---5 
--Country with highest infection count with date AS
...
---6
----TOTAL CASES VS TOTAL DEATHS IN THE NUNITED STATES
